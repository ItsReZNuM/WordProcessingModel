...
# =========================
VOCAB_SIZE = 30000         # اندازه واژگان
MAX_LEN = 40               # طول ثابت جمله (pad/truncate)
EMB_DIM = 200              # ابعاد embedding
BILSTM_UNITS = [128]       # مثل [128] یا [128, 64] برای چند لایه
DROPOUT = 0.3
REC_DROPOUT = 0.2
EPOCHS = 8
BATCH_SIZE = 128
...
def build_bilstm_model():
    ...
    # چند لایه BiLSTM (اگر لیست BILSTM_UNITS چندتا عدد داشته باشه)
    for i, units in enumerate(BILSTM_UNITS):
        return_seq = (i < len(BILSTM_UNITS) - 1)  # فقط لایه‌های میانی return_sequences=True
...
print("\n=== BiLSTM ===")
print("BILSTM_UNITS:", BILSTM_UNITS, "| EPOCHS:", EPOCHS, "| MAX_LEN:", MAX_LEN)
